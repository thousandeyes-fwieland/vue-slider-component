  ...
  return (function() {
    var e = {
            ...
            function t() {
              ...
              try {
                ...
                for (var f = 0; f < d.length; f++) {
                  ...
                  if (l === c && d[f].innerHTML && d[f].innerHTML.trim() === i) return d[f]
                }
                return null
              }
            }
        ...
        456: function(t, e, r) {
          ...
          var i = r(402).Z
          i('70c8b59e', n, !0, { sourceMap: !1, shadowMode: !1 })
        },
        560: function(t, e, r) {
          var n = r(554)
          n.__esModule && (n = n.default),
            ...
            n.locals && (t.exports = n.locals)
          var i = r(402).Z
          i('63658205', n, !0, { sourceMap: !1, shadowMode: !1 })
        },
        562: function(t, e, r) {
          var n = r(894)
          n.__esModule && (n = n.default),
            ...
            n.locals && (t.exports = n.locals)
          var i = r(402).Z
          i('21173b05', n, !0, { sourceMap: !1, shadowMode: !1 })
        },
        402: function(t, e, r) {
          'use strict'
          function n(t, e) {
            for (var r = [], n = {}, i = 0; i < e.length; i++) {
              var o = e[i],
                ...
                l = o[2],
                u = o[3],
                c = { id: t + ':' + i, css: s, media: l, sourceMap: u }
    ...
    return (
      (function() {
        ...
        var f = ['aria-valuetext'],
          h = { class: 'vue-slider-dot-tooltip-text' }
        ...
        var N,
          ...
          z = (function() {
            function t(e) {
              A(this, t), C(this, 'num', void 0), (this.num = e)
            }
            return (
              j(t, [
                {
        ...
        var nt =
            ((N = {}),
            tt(N, L.VALUE, 'The type of the "value" is illegal'),
            tt(
              N,
              L.INTERVAL,
              'The prop "interval" is invalid, "(max - min)" must be divisible by "interval"',
            ),
            tt(N, L.MIN, 'The "value" must be greater than or equal to the "min".'),
            tt(N, L.MAX, 'The "value" must be less than or equal to the "max".'),
            tt(
              N,
              L.ORDER,
              ...
              Q(t, [
                {
                  key: 'setValue',
                  value: function(t) {
                    this.setDotsValue(Array.isArray(t) ? W(t) : [t], !0)
                  },
                },
                {
                  key: 'setDotsValue',
                ...
                },
                {
                  ...
                  get: function() {
                    ...
                    var e = function(e, r) {
                      ...
                      return _({ pos: n, value: e, label: e, active: t.isActiveByPos(n) }, r)
                    }
                    return !0 === this.marks
                ...
                },
                {
                  ...
                  value: function(t) {
                    ...
                    return e.indexOf(Math.min.apply(Math, W(e)))
                  },
                },
                {
                  key: 'getIndexByValue',
                ...
                },
                {
                  ...
                  value: function(t) {
                    if (this.data) t = this.data.indexOf(t)
                      ...
                      if (((t = +t), t < this.min)) return this.emitError(L.MIN), 0
                      if (t > this.max) return this.emitError(L.MAX), 0
                      if ('number' !== typeof t || t !== t) return this.emitError(L.VALUE), 0
                      t = new z(t)
                        .minus(this.min)
                        .divide(this.interval)
                        .toNumber()
                  ...
                  get: function() {
                    if (this.process) {
                      ...
                      if (this.dotsPos.length > 1)
                        return [
                          [
                            Math.min.apply(Math, W(this.dotsPos)),
                            Math.max.apply(Math, W(this.dotsPos)),
                          ],
                        ]
                    }
                    return []
                    ...
                    return (
                      (t = this.data
                        ...
                        : new z(this.max)
                            ...
                            .divide(this.interval)
                            .toNumber()),
                      t - Math.floor(t) !== 0 ? (this.emitError(L.INTERVAL), 0) : t
                    )
                  },
                },
                {
        ...
        var At = { None: 0, Drag: 2, Focus: 4 },
          ...
          jt = (0, o.defineComponent)({
            name: 'VueSlider',
            components: { VueSliderDot: b, VueSliderMark: P },
            emits: ['change', 'drag-start', 'dragging', 'drag-end', 'error', 'update:modelValue'],
            data: function() {
              return { control: null, states: new ft(At), scale: 1, focusDotIndex: 0 }
            },
            props: {
            ...
            computed: {
              ...
              tailSize: function() {
                return w((this.isHorizontal ? this.height : this.width) || Vt)
              },
              ...
              containerStyles: function() {
                var t = Array.isArray(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize],
                  ...
                  r = e[0],
                  n = e[1],
                  i = this.width ? w(this.width) : this.isHorizontal ? 'auto' : w(Vt),
                  o = this.height ? w(this.height) : this.isHorizontal ? w(Vt) : 'auto'
                return {
                ...
                return this.control.processArray.map(function(e, r) {
                  ...
                  return {
                    ...
                    style: gt(
                      gt(
                        ((n = {}),
                        kt(n, t.isHorizontal ? 'height' : 'width', '100%'),
                        kt(n, t.isHorizontal ? 'top' : 'left', 0),
                        kt(n, t.mainDirection, ''.concat(o, '%')),
                        kt(n, u, ''.concat(a - o, '%')),
                        kt(n, 'transitionProperty', ''.concat(u, ',').concat(t.mainDirection)),
                        kt(n, 'transitionDuration', ''.concat(t.animateTime, 's')),
                        n),
                        t.processStyle,
                      ),
                      s,
            ...
            methods: {
              ...
              dragMove: function(t) {
                ...
                this.$emit('dragging', 1 === r.length ? r[0] : ht(r), this.focusDotIndex)
              },
              ...
              setValue: function(t) {
                this.control.setValue(Array.isArray(t) ? ht(t) : [t]), this.syncValueByPos()
              },
              setIndex: function(t) {
                var e = this,
                  r = Array.isArray(t)
              ...
              getPosByEvent: function(t) {
                return (
                  D(t, this.$el, this.isReverse, this.zoom)[this.isHorizontal ? 'x' : 'y'] /
                  this.scale
                )
              },
        ...
        const Ct = (0, v.Z)(jt, [['render', d]])
        var Bt = Ct
        ;(Bt.VueSliderMark = P), (Bt.VueSliderDot = b)
        var Mt = Bt,
          Nt = Mt
      })(),
      (i = i['default']),
